  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      workspace = [ 
        ...
        "2,name:Media, monitor:eDP-1, default:true"
        "3,name:Work, monitor:eDP-1, default:false"
        "4,name:Extra, monitor:eDP-1, default:false"
        "5,name:Relax, monitor:eDP-1, default:false"
      ];
